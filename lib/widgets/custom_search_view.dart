...
class CustomSearchView extends StatelessWidget {
  ...
  Widget get searchViewWidget => SizedBox(
        ...
        child: TextFormField(
          ...
          autofocus: autofocus!,
          style: textStyle ?? CustomTextStyles.bodyLargeSFProPrimaryContainer,
  ...
  InputDecoration get decoration => InputDecoration(
        hintText: hintText ?? "",
        hintStyle: hintStyle ?? CustomTextStyles.bodyLargeSFProPrimaryContainer,
        prefixIcon: prefix ??
            Container(
              margin: EdgeInsets.fromLTRB(8.h, 7.v, 5.h, 7.v),
